...
export const IconPlay = svg("M8 5v14l11-7z");
export const IconPause = svg("M6 19h4V5H6v14zm8-14v14h4V5h-4z");
export const IconPrev = svg("M6 6h2v12H6zm3.5 6l8.5 6V6z");
export const IconNext = svg("M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z");
...
export const IconThumbDown = svg(
...
export const IconQueue = svg(
  "M15 6H3v2h12V6zm0 4H3v2h12v-2zM3 16h8v-2H3v2zm15-6v8.18c-.31-.11-.65-.18-1-.18-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3V8h3V6h-5z"
);
